    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="card-title"><i class="fas fa-users"></i> Showing All Users </h4>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            @can('login_as', $user)
                                                <a href="{{url('login_as/'.$user->id)}}" class="btn btn-info" title="Login as this user"><i class="fas fa-user-secret"></i></a>
                                            @endcan
                                            @can('edit_user', $user)
                                                <a href="{{url('user/edit/'.$user->id)}}" class="btn btn-warning" title="Edit User"><i class="fas fa-edit"></i></a>
                                            @endcan
                                            @can('delete_user', $user)
                                                <a href="{{url('user/delete/'. $user->id)}}"  title="Delete User" class="btn btn-danger delete_user"><i class="fas fa-trash"></i> </a>
                                            @endcan
                                        </div>
                                    </td>
